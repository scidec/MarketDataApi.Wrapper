...
namespace MarketDataApi.Wrapper.Interfaces
{
    public interface IAPI
    {
        ...
        Task<List<Quote>> V1OptionQuotesAsync(string optionSymbol, DateTimeOffset? date = null, DateTimeOffset? from = null, DateTimeOffset? to = null, int? countback = null, int? limit = null, int? offset = null, bool? headers = null, string columns = null, bool? human = null);
